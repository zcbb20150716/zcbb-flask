...
function prepareCanvas(data)
{
	...
	crayonImage.src = "/images/draw/crayon-outline.png";
	//context.drawImage(crayonImage, 0, 0, 100, 100);
	
	markerImage.onload = function() { resourceLoaded(); 
	};
	markerImage.src = "/images/draw/marker-outline.png";
	
	eraserImage.onload = function() { resourceLoaded(); 
	};
	eraserImage.src = "/images/draw/eraser-outline.png";	
	
	crayonBackgroundImage.onload = function() { resourceLoaded(); 
	};
	crayonBackgroundImage.src = "/images/draw/crayon-background.png";
	
	markerBackgroundImage.onload = function() { resourceLoaded(); 
	};
	markerBackgroundImage.src = "/images/draw/marker-background.png";
	
	eraserBackgroundImage.onload = function() { resourceLoaded(); 
	};
	eraserBackgroundImage.src = "/images/draw/eraser-background.png";

	crayonTextureImage.onload = function() { resourceLoaded(); 
	};
	crayonTextureImage.src = "/images/draw/crayon-texture.png";
	
	outlineImage.onload = function() { resourceLoaded(); 
	};
	if (data == "yazi"){
		outlineImage.src = "/images/draw/yazi/watermelon-duck-outline.png";
	}else if(data == "qie"){
		outlineImage.src = "/images/draw/qie/watermelon-duck-outline.png";
	}else {
		outlineImage.src = "/images/draw/error.png";
	}
